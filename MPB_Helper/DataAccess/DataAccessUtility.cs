 ...
 * 
 * Apache License 2.0 - http://www.toptensoftware.com/DataAccessUtility/license
 * 
...
using DataAccessUtility.DatabaseTypes;
...
{
    /// <summary>
    /// The main DataAccessUtility Database class.  You can either use this class directly, or derive from it.
    /// </summary>
    public partial class Database : IDisposable
    {
        ...
        /// <remarks>
        /// The supplied IDbConnection will not be closed/disposed by DataAccessUtility - that remains
        ...
        /// <remarks>
        /// DataAccessUtility will automatically close and dispose any connections it creates.
        /// </remarks>
        ...
        public Page<T> Page<T>(long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            ...
            //reset row skip
            result.TotalPages = Convert.ToInt64(Math.Ceiling((double)result.TotalItems / itemsPerPage));
            if (result.TotalItems <= (page - 1) * itemsPerPage)
            {
                result.CurrentPage = result.TotalPages;
            }
            pageArgs[1] = (result.CurrentPage - 1) * itemsPerPage;
            //reset row skip
        ...
        /// <returns>A Page of results</returns>
        /// <remarks>
        /// DataAccessUtility will automatically modify the supplied SELECT statement to only retrieve the
...
#if !DataAccessUtility_NO_DYNAMIC
        ...
        /// <summary>
        /// When set to true, DataAccessUtility will automatically create the "SELECT columns" part of any query that looks like it needs it
        /// </summary>
    ...
    Usage:   
            ...
            new DataAccessUtility.Database("<connstring>", new DataAccessUtility.OracleProvider())
    ...
    assembly containing OracleProvider.cs)
        ...
        <system.data>
            <DbProviderFactories>
                <add name="DataAccessUtility Oracle Provider" invariant="Oracle" description="DataAccessUtility Oracle Provider" 
                                type="DataAccessUtility.OracleProvider, ASSEMBLYNAME" />
            </DbProviderFactories>
        </system.data>
    ...
    */
    ...
    /// <summary>
    /// IMapper provides a way to hook into DataAccessUtility's Database to POCO mapping mechanism to either
    ...
    /// DataAccessUtility through the static method Mappers.Register()
    /// </remarks>
    ...
    /// <summary>
    /// This static manages registation of IMapper instances with DataAccessUtility
    /// </summary>
    ...
    /// <summary>
    /// StandardMapper is the default implementation of IMapper used by DataAccessUtility
    /// </summary>
    ...
    namespace Internal
    {
        ...
        class MultiPocoFactory
        {
            ...
            public static object GetAutoMapper(Type[] types)
            {
                ...
                {
                    // Create a method
                    var m = new DynamicMethod("DataAccessUtility_automapper", types[0], types, true);
            ...
            {
                var m = new DynamicMethod("DataAccessUtility_multipoco_factory", typeof(TRet), new Type[] { typeof(MultiPocoFactory), typeof(IDataReader), typeof(object) }, typeof(MultiPocoFactory));
                var il = m.GetILGenerator();
        ...
        class PocoData
        {
            ...
            public Delegate GetFactory(string sql, string connString, int firstColumn, int countColumns, IDataReader r)
            {
                ...
                {
                    // Create the method
                    var m = new DynamicMethod("DataAccessUtility_factory_" + PocoFactories.Count.ToString(), type, new Type[] { typeof(IDataReader) }, true);
                    var il = m.GetILGenerator();
        ...
        internal static class PagingHelper
        {
            ...
            public static bool SplitSQL(string sql, out SQLParts parts)
            {
                ...
                //修改使用 group by 時無資料會回傳 null 改為回傳0 ,oracle Only
                //                parts.sqlCount = "select count(*) from(" + sql + ")";
                return true;
            }
