...
$(document).ready(function () {
    ...
    $("#tbResultsSysMbrMgmt").handsontable({     //set handsontable attribute
        data: HtData,
    ...
    Ht = $("#tbResultsSysMbrMgmt").handsontable('getInstance');
    //auto resize handsontable column width
    $.syncWin_WH.resizeFunctions.push({ func: handsontableResize, params: [$("#tbResultsSysMbrMgmt"), HtColSet] });//handsontableResize($("#tbResultsAuthUser"), HtColSet)
