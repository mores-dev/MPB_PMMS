...
$(document).ready(function () {
    ...
    $("#tbResultsSysBulletin").handsontable({     //set handsontable attribute
        data: HtData,
    ...
    Ht = $("#tbResultsSysBulletin").handsontable('getInstance');
    //auto resize handsontable column width
    $.syncWin_WH.resizeFunctions.push({ func: handsontableResize, params: [$("#tbResultsSysBulletin"), HtColSet] });//handsontableResize($("#tbResultsAuthUser"), HtColSet)
