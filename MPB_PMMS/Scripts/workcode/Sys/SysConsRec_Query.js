...
$(document).ready(function () {
    ...
    $("#tbResultsSysConsRec").handsontable({     //set handsontable attribute
        data: HtData,
    ...
    Ht = $("#tbResultsSysConsRec").handsontable('getInstance');
    //auto resize handsontable column width
    $.syncWin_WH.resizeFunctions.push({ func: handsontableResize, params: [$("#tbResultsSysConsRec"), HtColSet] });//handsontableResize($("#tbResultsAuthUser"), HtColSet)
