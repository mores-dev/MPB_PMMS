...
$(document).ready(function () {
    ...
    $("#tbResultsMgmtStation").handsontable({     //set handsontable attribute
        data: HtData,
    ...
    Ht = $("#tbResultsMgmtStation").handsontable('getInstance');
    //auto resize handsontable column width
    $.syncWin_WH.resizeFunctions.push({ func: handsontableResize, params: [$("#tbResultsMgmtStation"), HtColSet] });//handsontableResize($("#tbResultsAuthUser"), HtColSet)
