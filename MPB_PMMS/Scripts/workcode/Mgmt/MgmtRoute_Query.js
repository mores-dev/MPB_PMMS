...
$(document).ready(function () {
    ...
    $("#tbResultsMgmtRoute").handsontable({     //set handsontable attribute
        data: HtData,
    ...
    Ht = $("#tbResultsMgmtRoute").handsontable('getInstance');
    //auto resize handsontable column width
    $.syncWin_WH.resizeFunctions.push({ func: handsontableResize, params: [$("#tbResultsMgmtRoute"), HtColSet] });//handsontableResize($("#tbResultsAuthUser"), HtColSet)
