...
$(document).ready(function () {
    ...
    $("#btnBack").on("click", function (event) { $('form:first').vs_doSubmit({ actionPage: CancelPage, targetWin: "_self", postMethod: "post" }); });
...
function doSave() {
    ...
    $('form:first').vs_doSubmit({ actionPage: "AuthChgPwd_Save", postMethod: "post" });
}
