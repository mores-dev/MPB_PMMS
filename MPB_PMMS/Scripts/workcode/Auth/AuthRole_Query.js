...
$(document).ready(function () {
    ...
    $("#tbResultsAuthRole").handsontable({     //set handsontable attribute
        data: HtData,
    ...
    Ht = $("#tbResultsAuthRole").handsontable('getInstance');
    //auto resize handsontable column width
    $.syncWin_WH.resizeFunctions.push({ func: handsontableResize, params: [$("#tbResultsAuthRole"), HtColSet] });//handsontableResize($("#tbResultsAuthUser"), HtColSet)
