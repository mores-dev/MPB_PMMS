...
$(document).ready(function () {
    ...
    $("#tbResultsFCMVessel").handsontable({     //set handsontable attribute
        data: HtData,
    ...
    Ht = $("#tbResultsFCMVessel").handsontable('getInstance');
    //auto resize handsontable column width
    $.syncWin_WH.resizeFunctions.push({ func: handsontableResize, params: [$("#tbResultsFCMVessel"), HtColSet] });//handsontableResize($("#tbResultsAuthUser"), HtColSet)
