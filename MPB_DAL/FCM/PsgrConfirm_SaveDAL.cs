...
{
    public class PsgrConfirm_SaveDAL : DALBase
    {
        public PsgrConfirm_SaveDAL() { }

        public PsgrConfirm_SaveDAL(DbManager db) : base(db) { }
        ...
        public int Insert_cVessel(PsgrConfirm_SaveMain sm)
        {
            string sql = "";
        ...
        public int Update_cVessel(PsgrConfirm_SaveMain sm)
        {
            string sql = "";
            sql += "UPDATE cVessel ";
            sql += " SET ";
        ...
        public int Delete_cVessel(PsgrConfirm_SaveMain sm)
        {
            string sql = "";
            sql += "UPDATE cVessel ";
            sql += " SET ";
